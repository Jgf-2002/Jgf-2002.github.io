...
const experience = [
  {
    ...
    org: "大寒智能量化公司",
    role: "量化研究实习生",
    scope: "A 股因子研究 · 宏观配置 · PIT 数据基础设施",
    points: [
      "负责 A 股基本面与分析师预期 Alpha 研究，整理 253 个因子定义，完成 178 个 Dolphin / PySim 可运行实现，并统一检验覆盖率、IC、RankIC 与跨年度稳定性。",
      "建立 20 日尺度市场 Beta 因子库，登记并检验 790 余种价格、估值、流动性、订单流和技术形态构造；以非重叠相位、环移空检验、联合回归和残差 IC 筛选独立增量。",
      "构建月频宏观 PIT 面板与多资产配置框架，覆盖货币、信用、增长、通胀及市场确认指标；完成样本外回测、参数敏感性、确定性复跑与历史压力阶段审计。",
      "建设财务及分析师数据基础设施：开发 Dolphin 原生 PIT 加载器，维护聚源 JY 与 Tushare 增量同步、历史可见性规则、批量仿真和每日质量检查；当前管理约 131 GB 历史数据。",
    ],
  },
  {
